...
public class Controller {
    ...
    private VBox createIntMappingArea(String heading, Object container, List<Field> fields) throws IllegalAccessException {
        VBox area = new VBox();
        ...
        for (int i = 0; i < fields.size(); i++) {
            ...
            ForwardingIntField input = new ForwardingIntField(0, 100, (Integer)field.get(container));
        ...
        area.getChildren().addAll(headingLabel, pane);
        return area;
    }

    private VBox createOptionArea(String heading, Object container, List<Field> fields) throws IllegalAccessException {
        VBox area = new VBox();
        area.setSpacing(10);
        area.setAlignment(Pos.TOP_CENTER);
        ...
        Label headingLabel = new Label(heading);
        headingLabel.getStyleClass().add("heading");
        area.getChildren().add(headingLabel);
    ...
    private VBox createBackgroundArea(String heading, Object container, List<Field> fields) throws IllegalAccessException {
        VBox area = new VBox();
        area.setSpacing(10);
        area.setAlignment(Pos.TOP_CENTER);
